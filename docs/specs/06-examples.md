...
- Maven Central (live on repo1): `io.github.deemwario:mochallama-core:0.1.1`,
  `:mochallama-core:0.1.1:natives-<os>-<arch>` (5 platforms),
  `:mochallama-core-platform:0.1.1` (aggregator), `:mochallama-spring-boot-starter:0.1.1`,
  `:mochallama-spring-ai:0.1.1`.
...
- Deps: `io.github.deemwario:mochallama-core:0.1.1` + `io.github.deemwario:mochallama-core-platform:0.1.1` (runtimeOnly, natives).
...
- Deps: `io.github.deemwario:mochallama-spring-boot-starter:0.1.1` + `:mochallama-core-platform:0.1.1` (runtimeOnly) + `spring-boot-starter-web`.
...
- Spring Boot 3.3.1 + `mochallama-spring-ai:0.1.1` + `mochallama-spring-boot-starter:0.1.1` + `:mochallama-core-platform:0.1.1` + `org.springframework.ai:spring-ai-client-chat:1.0.8`.
